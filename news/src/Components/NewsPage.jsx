...
export default function NewsPage(props) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=0ed5c729b8794bf7be813302c891f3c1&pageSize=${props.pageSize}`);
                if (!response.ok) {
